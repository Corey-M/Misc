/*
Code adapted from item posted on CodeGuru forum by user Norfy

	Original:	http://forums.codeguru.com/showthread.php?279221-xor-drawing-mode
*/
using System;
...
namespace ADPhotoPrep
{
	...
	public static class GDI
	{
		...
		public static void DrawXORRectangle(this Graphics graphics, Pen pen, Rectangle rectangle)
		{
		...
		public static void DrawXORLine(this Graphics graphics, Pen pen, int x1, int y1, int x2, int y2)
		{
			IntPtr hDC = graphics.GetHdc();
			IntPtr hPen = Gdi32.CreatePen(0, (int)pen.Width, ArgbToRGB(pen.Color.ToArgb()));
			Gdi32.SelectObject(hDC, hPen);
		...
		public static void DrawXORLine(this Graphics graphics, Pen pen, Point from, Point to)
		{
			graphics.DrawXORLine(pen, from.X, from.Y, to.X, to.Y);
		}
